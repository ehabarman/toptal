...
import com.toptal.backend.security.jwt.JwtTokenUtil;
...
import com.toptal.backend.errors.CustomExceptions.InvalidCredentialsException;
import com.toptal.backend.payload.response.JwtResponse;
import com.toptal.backend.payload.request.JwtRequest;
...
public class JwtAuthenticationController {
    ...
    public JwtResponse createAuthenticationToken(@RequestBody JwtRequest authenticationRequest) throws Exception {
        ...
        return new JwtResponse(token, StringUtil.format("%s seconds", expirationTime));
    }
