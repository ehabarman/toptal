...
import com.toptal.toptal.backend.errors.handler.AccessDeniedExceptionHandler;
import com.toptal.toptal.backend.security.jwt.JwtRequestFilter;
import com.toptal.toptal.backend.security.jwt.JwtAuthenticationEntryPoint;
...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    private void configureApiAccess(HttpSecurity httpSecurity) throws  Exception {
        httpSecurity
                ...
                .antMatchers("/api/users/detail").hasAnyRole(SYS_ADMIN, MANAGER, USER_ADMIN)
