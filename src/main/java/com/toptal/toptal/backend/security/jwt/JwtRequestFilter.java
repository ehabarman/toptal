...
import static com.toptal.toptal.backend.util.Constants.*;
...
public class JwtRequestFilter extends OncePerRequestFilter {
    ...
    private String extractUsernameFromToken(String jwtToken) throws MissingServletRequestParameterException {
